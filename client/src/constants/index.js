/**
 * @constant {Object} MAP_CONFIG - Configuration for Google Maps integration
 */
export const MAP_CONFIG = {
  DELHI_CENTER: { lat: 28.6139, lng: 77.209 },
  DEFAULT_ZOOM: 13,
  SEARCH_ZOOM: 14,
  DETAIL_ZOOM: 16,
  DARK_STYLES: [
...
/**
 * @constant {Array} SUGGESTED_QUESTIONS - Common user queries for the AI Chat
 */
...
/**
 * @constant {Array} ELECTION_STEPS - Sequential stages of the Indian election process
 */
export const ELECTION_STEPS = [
  {
    ...
    color: '#FF9933',
    summary: 'The Election Commission of India (ECI) announces the election schedule, activating the Model Code of Conduct (MCC).',
...
**Legal Basis:** Article 324 of the Indian Constitution`,
    geminiPrompt: 'Explain in detail how the Election Commission of India announces elections and what the Model Code of Conduct means for citizens.',
  },
  {
    id: 2,
    icon: '📋',
    ...
    color: '#138808',
    summary: 'Citizens aged 18+ can register as voters using Form 6 on the NVSP portal (voters.eci.gov.in) or via the Voter Helpline App.',
...
**Qualifying Date:** January 1st of the year of the revision`,
    geminiPrompt: 'Walk me through the complete voter registration process in India, including Form 6, the NVSP portal, and what documents are needed.',
  },
  {
    id: 3,
    icon: '📝',
    ...
    color: '#9333ea',
    summary: 'Candidates file nomination papers with a deposit. Papers are scrutinized and candidates can withdraw within the deadline.',
...
- Being declared insolvent`,
    geminiPrompt: 'Explain the process of nomination of candidates for Indian elections, including filing, scrutiny, deposits, and withdrawal.',
  },
  {
    id: 4,
    icon: '🎤',
    ...
    color: '#0ea5e9',
    summary: 'Political parties campaign within MCC guidelines. Campaign silence begins 48 hours before polling. No cash/gifts to voters.',
...
- State Assembly: ₹40 lakh per constituency`,
    geminiPrompt: 'What are the rules for election campaigning in India under the Model Code of Conduct? What is not allowed?',
  },
  {
    id: 5,
    icon: '🗳️',
    ...
    color: '#f59e0b',
    summary: 'Voters cast their vote on an EVM. A VVPAT slip confirms the vote. Polling typically runs from 7 AM to 6 PM.',
...
**Polling Hours:** Generally 7:00 AM to 6:00 PM (may vary by constituency)`,
  ...
  },
  {
    ...
    color: '#ef4444',
    summary: 'Counting happens at designated centres. EVMs are unsealed and votes tabulated round by round. Results declared constituency-wise.',
...
- Party reaching majority (272 for Lok Sabha) forms the government`,
    geminiPrompt: 'How are votes counted in Indian elections? What is the role of postal ballots and VVPAT verification?',
  },
  {
    id: 7,
    icon: '🏛️',
    ...
    color: '#8b5cf6',
    summary: "The party/alliance with majority forms the government. President invites the leader to form the government. PM/CM takes oath.",
...
- Newly elected Lok Sabha/Vidhan Sabha members elect a Speaker as the first business`,
    geminiPrompt: 'How is a government formed after Indian elections? What happens if no party gets a majority? Explain coalition government.',
  },
];
